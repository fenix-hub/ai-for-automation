...
#	})
	...
	lstPointsRoute = [["29975400#3","29975386#1"],["29975386#1","29975400#3"],["69135107#0","29976859#7"],["29976859#7","69135107#0"]]

	lstPointsRoute = [["29975400#3", "69135107#0"]]
	agent = ppo.PPO(env=drlclass.routeplannerfull.Routeplanner, config={
			"env_config": {"lstPoints": lstPointsRoute,"flagPriorityReward":False,"folder":"scenario5","pathRouteFile":"example_drl.rou.xml"},
			"num_workers": 0
		})
